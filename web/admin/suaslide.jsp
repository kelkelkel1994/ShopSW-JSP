                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form action="/ShopSW/ManagerSlideServlet" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="tenImg" value="<%=c.getImage()%>" readonly>
                                            </div>

                                            <label>DisplayOrder</label>
                                            <input type="text" class="form-control" name="tenDisplay" value="<%=c.getDisplayorder()%>">
                                            <div class="form-group">
                                                <label>Link</label>
                            ...
                            <input type="hidden" name="ID_Slide" value="1">
